    ...
    public partial class initialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProductCategoies", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.ProductCategoies",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCategoies");
            ...
            DropTable("dbo.Pages");
            DropTable("dbo.ProductCategoies");
